...
class UserAdmin(BaseUserAdmin):
    ...
    def get_actions(self, obj):
        ...
        attempts_url = reverse('admin:users_loginattempt_changelist') + f'?login_identifier={obj.email}'
        actions.append(
...
class LoginAttemptAdmin(admin.ModelAdmin):
    """Login Attempt Admin - Security focused"""

    list_display = (
        'get_login_info',
        'get_login_type_badge',
        'get_success_badge',
        'ip_address',
        'failure_reason',
        'created_at_short',
    ...
    def get_location_info(self, obj):
        ...
        if obj.ip_address:
            if obj.ip_address.startswith('127.') or obj.ip_address.startswith('192.168.'):
                location = '🏠 Local'
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        extra_context['security_stats'] = {
            'today_attempts': LoginAttempt.objects.filter(created_at__date=today).count(),
